...
meeting_content = {
    ...
    False: [
        ContentUnit("text", "- Ну и жара, сегодня, правда? - сказал ты, желая завести разговор с девушкой неподалёку."),
        ContentUnit("text",
...
content = [
    ...
    ContentUnit("text", "Студентам сообщают о том, что ПО ЛЮБЫМ ВОПРОСАМ, которые могут возникнуть у них в университете, они свободно могут обращаться в 319 кабинет, так называемый “остров надежды”.", delay=2),
