...
meeting_content = {
    ...
    False: [
        ...
        ContentUnit("text",
                    "Да, это точно. Будто нас ждала. Я думала из Монголии сюда приеду, от жары отдохну, а она меня и здесь достала. Ты иди ко мне, здесь в тени легче."
                    ""
                    "Как тебя звать? (впиши свое имя)")
    ]
}
...
say_name_content = {
    ...
    False: [
        ContentUnit("text", "#name, - сообщила ты, прячась от зноя под тень дерева.", delay=0),
...
buttons = {"Пойти вместе на встречу.": "I_c_03_00",
