...
say_name_content = {
    True: [
        ContentUnit("text", "Меня #name зовут, - сообщил ты, смеясь над шуткой.", delay=0),
    ...
    False: [
        ContentUnit("text", "Меня #name зовут, - сообщила ты, прячась от зноя под тень дерева.", delay=0),
        ContentUnit("text", "Очень приятно, Яна, - ответила новая знакомая.", delay=0),
        ContentUnit("text", "В это время уже подъезжал автобус.", delay=0)
    ]
}
buttons = {"Сесть в автобус": "I_b_00_00"}
...
say_name_content[False][0] = ContentUnit("text", "Меня #name зовут, - сообщила ты.", delay=0)
...
content = {
    ...
    False: [
        ...
        ContentUnit("text", "Да, это был тяжелый день. Зайдя в комнату, ты завалился на кровать и уснула")
    ]
}
buttons = {"Следующий день": "II_a_00_00"}
...
ContentUnit("text", "Наступило утро.", delay=2),
        ...
        ContentUnit("text", "Ты встаешь с кровати с чувством бодрости, смешанным со слабостью после вчерашнего дня."),
        ContentUnit("text", "Собравшись на утренние процедуры, ты направляешься в уборную."),
        ContentUnit("text", "Внезапно, распахивается дверь неподалёку, и из неё выходит Яна, с полотенцем на плече."),
        ContentUnit("text",
                    "Встретившись взглядами, вы замираете на мгновение, как два ковбоя, готовящиеся к перестрелке."),
        ContentUnit("text", "Ты решаешь:")
    ]
