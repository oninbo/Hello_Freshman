...
content = {
    True: [
        ...
        ContentUnit("text",
                    '- Ребята, я вам сейчас раздаю "Анкету для заселения". Заполните ее, пожалуйста, до приезда в Иннополис. Если у кого-то нет ручки, у меня есть пара штук. А так поделитесь друг с другом, пожалуйста.'),
...
content = {
    True: [
        ...
        ContentUnit("text",
                    '"Как же здесь приятно и прохладно. Кондиционеры прилежно выполняют свою работу", - думаешь ты. На входе вас встречают студенты-волонтеры.'),
        ContentUnit("photo", photos.urls["students"]),
        ContentUnit("text", "Эх, тянет мысли на еду. Проголодался. Перекусить бы…"),
        ContentUnit("text",
                    "- Всем привет, ставьте по очереди свои вещи на ленту и проходите, пожалуйста, к стойке-регистрации."),
        ContentUnit("text", "Когда пришла твоя очередь, ты подходишь к ресепшену."),
        ContentUnit("text",
                    "- Добрый день! - улыбнывшись, поприветствовала тебя девушка-администратор. - Ваша фамилия?"),
...
content = {
    True: [
        ContentUnit("text",
                    "- Вот твоя футболка. Важно! В 18:00 в аудитории 107 в университете состоится организационная встреча. На ней быть обязательно! Уже послее нее можно будет сходить на ужин. На обороте твоего бейджа есть штрих-код, по нему и пробьешь питание в столовой."),
...
say_name_content = {
    True: [
        ...
        ContentUnit("text", "- Очень приятно, Иван, - бросил новый знакомый, улыбаясь в ответ."),
        ContentUnit("text",
                    "Посмотрев на часы (17:30), новый сосед решает пойти в университет на встречу со студентами.")
    ],
    False: [
        ContentUnit("text", "- Меня #name зовут, - сообщила ты,."),
        ContentUnit("text", "- Очень приятно, Яна, - ответила новая знакомая."),
        ContentUnit("text",
                    "Посмотрев на часы (17:30), новая соседка решает пойти в университет на встречу со студентами.")
    ]
}
...
content = [
    ...
    ContentUnit("text",
                "Вы приходите на встречу с десятиминутным минутным запасом, усаживаетесь в аудиторию и готовитесь слушать."),
...
buttons = {"Дальше": "I_c_03_00_masyagin"}
states["I_c_03_00_dyuster"] = State(content, buttons)

# == TODO: CHECK
# I_c_03_00_masyagin
content = [
    ContentUnit("text", "Проректор - начальник управления по работе со студентами и абитурентами  - Сергей Масягин,"),
...
buttons = {"Дальше": "II_a_00_00_next"}
...
buttons = {"Дальше": "II_a_00_00_female_next"}
...
content = {
    True: [
        ContentUnit("text", "Сломя голову, крича: «Я первый!», ты летишь в сторону уборной.", delay=2),
        ContentUnit("text",
                    "Сосед остался в дверном проёме, в замешательстве выпучив глаза на твой внезапный марш-бросок.",
                    delay=2)
    ],
    False: [
        ContentUnit("text", "Сломя голову, крича: «Я первая!», ты летишь в сторону уборной.", delay=2),
        ContentUnit("text",
...
content = {
    True: [
        ...
        ContentUnit("text",
                    "Убрав за собой поднос, вы с соседом направились в читальный зал на 3-м этаже на ориентационный семинар, который в рамках Летней школы будет проводиться каждый учебный день перед лекцией.")
    ],
    False: [
        ...
        ContentUnit("text", "https://my.university.innopolis.ru/"),
        ContentUnit("text",
                    "Убрав за собой поднос, вы с соседкой направились в читальный зал на 3-м этаже на ориентационный семинар, который в рамках Летней школы будет проводиться каждый учебный день перед лекцией.")
    ]
}
buttons = {"Дальше": "II_a_02_00_seminar"}
...
content = [
    ...
    ContentUnit("text",
                "На семинаре вы ближе познакомились с другими участниками BootCamp и определили тему дня, чтобы уже вечером в маленьких группах с тьютором обработать полученный материал."),
]
...
content = [
    ...
    ContentUnit("text", "После семинара вы направились на свою первую лекцию в Иннополисе. Круто!", delay=2),
    ContentUnit("text",
...
buttons = {"Дальше": "II_a_07_00_next"}
...
# III_a_00_00
content = [ContentUnit("text",
                       "Еще один день в BootCamp, который, как всегда, начинается с  ориентационного семинара, за которым следует череда занятий."),
           ContentUnit("photo", photos.urls["lecture"]),
           ContentUnit("text",
                       "Во время перерыва между лекцией и семинаром (lab Session) приятель, который ходит с тобой на занятия, сказал:"),
           ContentUnit("text",
                       "- Я что-то не очень разобрался, как тут устроено всё в плане преподавания и организации курса.")
           ]
...
content = [
    ContentUnit("text",
                "- Только если вопрос к ТА остался нерешенным. В таком случае лучше написать профессору на электронную почту с просьбой назначить встречу либо попробовать решить вопрос онлайн. В Телеграме писать не стоит, т.к. профессора общаются через официальные каналы связи."),
...
buttons = {
    "Дальше": "III_b_02_00_sportcomplex"
}
...
buttons = {
    "Дальше": "III_b_02_00_sviyaga"
}
states["III_b_02_00_postoffice"] = State(content, buttons)

# III_b_02_00_sviyaga
content = [
    ContentUnit("text", "Город-Курорт “Свияга Хиллз” ⛳️🏂 \n\n"
...
content = [
    ...
    ContentUnit("text", "Председатель Студенческой Ассоциации.\n\n"
                        "Камилл Гусманов (@GusmanovKamill)\n"
...
buttons = {"Дальше": "III_c_00_00_nikita"}
...
content = {
    True: [
        ...
        ContentUnit("text",
                    "- Подробная информация о всем этом есть на сайте университета"),
        ContentUnit("text",
...
content = {
    ...
    False: [
        ContentUnit("text",
                    "В комнату вбегает Яна. Вот это действительно позитивный человек! Всегда шутит, побольше бы таких людей…"),
        ContentUnit("text", "- Хей! Я смотрю, ты проснулась, давай, вставай быстрее, соня, там новые книги завезли!!"),
        ContentUnit("photo", photos.urls["library"]),
        ContentUnit("text", "- Да, я знаю. Пошли."),
        ContentUnit("text",
...
content = [
    ...
    ContentUnit("text",
                "- Пошли сядем вон туда. Это Паша, может, ты его знаешь, он был у меня на отборах. Волонтёрил."),
    ContentUnit("text", "- Пошли."),
    ContentUnit("text", "- Привет, Паш, как дела?"),
    ContentUnit("text",
                "- О, какие люди, я тебя помню! Любишь поспать и везде опаздываешь из-за этого."),
    ContentUnit("text", "Все рассмеялись."),
    ContentUnit("photo", photos.urls["guys"]),
    ContentUnit("text", "- Дела у меня отлично, наконец-то поменял план питания."),
...
content = [
    ...
    ContentUnit("text", "- кафе 'CG' (@GeekCaffeeBot, работает доставка)"),
    ContentUnit("text", "- столовая 4 корпуса 'INNOEDA!' (@GeekCaffeeBot)"),
    ContentUnit("text",
                "- пиццерия 'Cacio e Vino' (https://goo.gl/NeHeCT, доставки нет, но можно делать предзаказ на вынос)"),
    ContentUnit("text",
    ...
    ContentUnit("text", "Ты думаешь 'Офигенная толстовка. Тоже такую хочу!' и спрашиваешь:")
]
buttons = {
...
content = [
    ...
    ContentUnit("text",
                "- Ты действительно вообще ничего не читаешь, что приходит нам в рассылках (рассмеялась она). Эта, по-моему, 1800 иннопоинтов, а посмотреть сколько их у тебя сейчас можно на портале «Юис»:\n uis.university.innopolis.ru/innopoints/products"),
    ContentUnit("text", "- Впервые слышу…"),
    ContentUnit("text", "В диалог вмешался roommate:"),
    ContentUnit("text",
                "- Вы знали, что иннопоинты студенты придумали и разработали вместе с отделом по поддержке и развитию студентов? Вот так вот. Если бы тогда не возникла у них такая идея, не было бы сейчас иннопоинтов. Минутка истории от меня ;)"),
...
# IV_c_02_01
content = [
    ContentUnit("text", "Ты уходишь в свою комнату и заваливаешься спать.")
]
...
# V_a_00_00
content = [
    ContentUnit("text", "Наступил твой пятый день в летней школе."),
...
content = {
    True: [
        ...
        ContentUnit("text",
                    "Направляешься умываться. Открыв кран, ты получаешь внезапный мощный поток воды. Окатив половину комнаты вместе с тобой, вода также внезапно заканчивается. Затем следуют звуки звериного рыка и хлюпанье из крана."),
...
content = {
    True: [
        ...
        ContentUnit("text",
                    "За соблюдением правил следит профессор. ТА ходят по аудитории и не упускают из виду ни единого студента."),
    ],
    False: [
        ContentUnit("text", "Ты закрываешь кран... Открываешь снова. Вода пошла нормально."),
...
buttons = {"Дальше": "V_a_03_00_next_1"}
...
buttons = {"Дальше": "V_a_03_00_next_2"}
...
buttons = {"Написать в Телеграме соседу": "V_a_04_00",
...
buttons = {"Дальше": "V_a_05_00_next_1"}
...
buttons = {"Дальше": "V_a_05_00_next_2"}
...
buttons = {"Начать новый день": "VI_a_00_00"}
...
content = [
    ContentUnit("text",
                "- Ага. Там куча сувениров с символикой университета: толстовки, кружки, рюкзаки и еще много всего. Еще можно обменять на сертификаты партнеров УИ."),
...
content = [
    ...
    ContentUnit("text",
                "- Да ну, очередь в туалет наверное, постоянно… Зато я точно знаю, чьи продукты в холодильнике, если они не мои. Стоит, конечно, чуток дороже. Пятиместка - примерно 2100 рублей/месяц, а двухместка - 2400 рублей/месяц."),
...
content = [
    ContentUnit("text",
                "- Кажется в середине мая… Да, точно, 14 мая - последний день, только ведь там еще стажировка."),
    ContentUnit("text", "- И когда она будет? И что это вообще такое?"),
    ContentUnit("text",
                "- Точную информацию нам должны сказать к концу года, думаю. Поэтому не стоит пока делать точные планы, хотя бы начало лета постараться оставить свободным. Я знаю, что они подразделяются на административные и научные, и в компании мы можем идти только после второго курса."),
...
# VI_c_01_00
content = [
    ContentUnit("text", "Стоящий рядом студент:"),
    ContentUnit("text", "- Вас должно обрадовать, что здесь праздник почти каждый день."),
    ...
    ContentUnit("text", "Independent Activities Weekend (апрель)"),
    ContentUnit("photo", photos.urls["IAW"]),
    ContentUnit("text", "Slippers of the Year (май)"),
