...
content = [
    ...
    ContentUnit("text"," На семинаре вы ближе познакомились с другими участниками BootCamp и определили тему дня, чтобы уже вечером в маленьких группах с тьюторам обработать полученный материал.", delay=3),
